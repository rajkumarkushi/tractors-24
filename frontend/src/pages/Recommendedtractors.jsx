// frontend/src/pages/RecommendedTractors.jsx
    ...
    >
      <Box sx={{ position: 'relative' }}>
        <CardMedia
          ...
          alt={tractor.brand || 'Tractor Image'}
          sx={{ objectFit: 'cover' }}
          onError={(e) => {
...
const RecommendedTractors = () => {
  ...
  useEffect(() => {
    fetchRecommendedTractors();
  }, []);

  const fetchRecommendedTractors = async () => {
    try {
      setLoading(true);
      ...
      if (response.data.success) {
        ...
        setError('Failed to load recommended tractors');
      }
    } catch (err) {
      console.error('Error fetching recommended tractors:', err);
      setError(err.response?.data?.message || 'Failed to load recommended tractors');
    } finally {
      setLoading(false);
    }
  };
...
export default RecommendedTractors;